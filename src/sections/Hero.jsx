  ...
  return (
    <section style={{ minHeight:'100vh', display:'flex', alignItems:'center', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ position:'absolute', inset:0, pointerEvents:'none' }}>
        <div className="aurora" style={{ position:'absolute', top:'10%', left:'25%', width:700, height:700, borderRadius:'50%', background:'radial-gradient(circle,rgba(59,130,246,0.16),transparent 70%)', filter:'blur(50px)' }}/>
        ...
        <div className="aurora" style={{ position:'absolute', bottom:'10%', left:'10%', width:350, height:350, borderRadius:'50%', background:'radial-gradient(circle,rgba(129,140,248,0.09),transparent 70%)', filter:'blur(40px)', animationDelay:'-16s' }}/>
      </div>
      ...
      <div className="container" style={{ paddingTop:128, paddingBottom:80, position:'relative', zIndex:1 }}>
        <div className="hero-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center' }}>
          ...
          <div>
            ...
            <motion.p {...fadeUp(0.34)} style={{ fontSize:17, color:'#94A3B8', lineHeight:1.72, maxWidth:470, marginBottom:38 }}>
              Torque Network is India's invite-first creator community — where vetted creators grow together, build meaningful reach, and shape the future of content.
            </motion.p>
            ...
            <motion.div {...fadeUp(0.46)} style={{ display:'flex', flexWrap:'wrap', gap:14, marginBottom:48 }}>
              <a href="#community" className="btn-primary" style={{ fontSize:15, padding:'16px 30px' }}>
                Join the Founding Community <ArrowRight size={16}/>
              </a>
            ...
            <motion.div {...fadeUp(0.56)} style={{ display:'flex', alignItems:'center', gap:18 }}>
              <div style={{ display:'flex' }}>
                {['#3B82F6','#22D3EE','#818CF8','#F59E0B','#EC4899'].map((c,i) => (
                  <div key={i} style={{
                    ...
                    border:'2px solid #050816', display:'flex', alignItems:'center',
                    justifyContent:'center', fontSize:11, fontWeight:700, color:'#fff',
                    marginLeft: i>0 ? -11 : 0, zIndex:5-i,
              ...
              <div>
                <div style={{ fontSize:13.5, fontWeight:600, color:'#F8FAFC' }}>380+ creators on the waitlist</div>
                <div style={{ fontSize:12, color:'#475569', marginTop:2 }}>Applications close soon · Invite-first access</div>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="float-a" style={{
              position:'absolute', top:55, right:0, zIndex:10,
              background:'rgba(13,19,38,0.88)', backdropFilter:'blur(24px)',
              border:'1px solid rgba(34,211,238,0.22)', borderRadius:20,
              padding:'16px 20px', width:188,
            }}>
              <div style={{ display:'flex', alignItems:'center', gap:9, marginBottom:9 }}>
                <div style={{ width:30, height:30, borderRadius:'50%', background:'linear-gradient(135deg,#EC4899,#8B5CF6)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, fontWeight:700, color:'#fff', flexShrink:0 }}>A</div>
                <span style={{ fontSize:12.5, fontWeight:500, color:'#F8FAFC' }}>@aanya.creates</span>
              </div>
              <div style={{ fontSize:11.5, color:'#22D3EE', marginBottom:7 }}>↑ 340% more reach</div>
              <div style={{ height:3, background:'rgba(255,255,255,0.07)', borderRadius:2 }}>
                <div style={{ width:'82%', height:'100%', background:'linear-gradient(90deg,#3B82F6,#22D3EE)', borderRadius:2 }}/>
              </div>
            </div>
            ...
            <div className="float-c" style={{
              ...
              padding:'16px 20px', width:172,
            }}>
              <div style={{ display:'flex', alignItems:'center', gap:7, marginBottom:6 }}>
                <Sparkles size={14} color="#F59E0B"/>
                <span style={{ fontSize:11, color:'#94A3B8', fontWeight:500 }}>Community Match</span>
              </div>
            ...
            <div className="float-b" style={{
              position:'absolute', top:'40%', left:-30, zIndex:10,
              background:'rgba(13,19,38,0.85)', backdropFilter:'blur(20px)',
              border:'1px solid rgba(129,140,248,0.2)', borderRadius:16,
              padding:'12px 16px', width:148,
            }}>
              <div style={{ fontSize:10.5, color:'#94A3B8', marginBottom:4 }}>Collab Request</div>
              <div style={{ fontSize:13, fontWeight:600, color:'#F8FAFC', fontFamily:'Space Grotesk' }}>@tech.vikas</div>
              <div style={{ fontSize:10.5, color:'#818CF8', marginTop:4 }}>Tech · 28K followers</div>
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div style={{ position:'absolute', bottom:32, left:'50%', transform:'translateX(-50%)', display:'flex', flexDirection:'column', alignItems:'center', gap:8 }}>
        <span style={{ fontSize:9, color:'#2D3748', letterSpacing:'0.18em', textTransform:'uppercase' }}>Discover</span>
        <motion.div
          style={{ width:1, height:44, background:'linear-gradient(to bottom,#3B82F6,transparent)' }}
      ...
      <style>{`
        ...
        @media(max-width:900px){
          ...
          .hero-3d{ height:360px !important; }
