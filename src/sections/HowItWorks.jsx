...
const BENEFITS = [
  {
    ...
    desc: "Stronger numbers on every post you publish.",
  },
  {
    icon: Zap,
    color: "#22D3EE",
    title: "Wider Reach",
    desc: "Get discovered by audiences beyond your existing followers.",
  },
  {
    icon: RefreshCw,
    color: "#818CF8",
    title: "A Network That Grows With You",
    desc: "Every new member adds to your amplification at no extra cost.",
  },
];
...
function StepNode({ step, index, inView }) {
  ...
  return (
    <motion.div
      ...
      animate={nodeInView ? { opacity: 1, y: 0 } : {}}
      transition={{
        duration: 0.7,
    ...
    >
      <motion.div
        ...
        whileHover={{
          scale: 1.18,
          boxShadow: `0 0 44px ${step.color}cc`,
        }}
        style={{
          width: 68,
          height: 68,
...
export default function HowItWorks() {
  ...
  return (
    <section
      ...
      id="how-it-works"
      style={{ background: "rgba(13,19,38,0.28)" }}
    >
      <div className="container">
        {/* Heading */}
        <motion.div
        ...
        >
          ...
          <motion.div
            style={{
              ...
              height: 1.5,
              background:
                "linear-gradient(90deg,#3B82F6,#22D3EE,#818CF8,#F59E0B)",
              borderRadius: 2,
              width: lineWidth,
            }}
          />
          ...
          >
            {STEPS.map((s, i) => (
              <StepNode key={s.num} step={s} index={i} inView={inView} />
            ))}
          </div>
        </div>
                  ...
                  {i < STEPS.length - 1 && (
                    <div
                      style={{
                        ...
                        flex: 1,
                        marginTop: 8,
                        background: `linear-gradient(to bottom,${s.color}50,transparent)`,
                        minHeight: 32,
                      }}
                    />
                  )}
          ...
          {BENEFITS.map((b, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{
                  y: -6,
                  boxShadow: `0 24px 60px ${b.color}18`,
                }}
                style={{
                  borderRadius: 20,
                  padding: "28px 26px",
